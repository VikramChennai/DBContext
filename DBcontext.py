import asyncpg
from PostgreSQL.postgreSQL import get_postgreSQL_schema_Better,get_postgreSQL_schema_Bad
...
class DBContext():
    ...
    async def get_postgreSQL_schema_Bad(self, host: str, port: int, username: str, password: str, databases: str) -> str:
        self.postgreSQL_schema = await get_postgreSQL_schema_Bad(host, port, username, password, databases)
        return self.postgreSQL_schema
